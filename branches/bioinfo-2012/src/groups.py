...
from thermodynamic_constants import R, default_pH, default_T,\
    dG0_f_Mg, default_I, default_pMg, RedoxCarriers
from thermodynamics import MissingCompoundFormationEnergy,\
    PsuedoisomerTableThermodynamics
from group_decomposition import GroupDecompositionError, GroupDecomposer
from kegg import Kegg
from kegg_errors import KeggReactionNotBalancedException
from groups_data import Group, GroupsData
from html_writer import HtmlWriter, NullHtmlWriter
from linear_regression import LinearRegression
from database import SqliteDatabase
from sparse_kernel import SparseKernel, CplexNotInstalledError
from molecule import Molecule
from group_observation import GroupObervationCollection
from dissociation_constants import DissociationConstants
...
class GroupContribution(PsuedoisomerTableThermodynamics):    
    ...
    def EstimateKeggCids(self, cid_list=None):
        ...
        observed_species = PsuedoisomerTableThermodynamics.FromCsvFile(
            '../data/formation_energies.csv', label='testing')
