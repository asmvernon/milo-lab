...
import kegg_compound, kegg_reaction, kegg_enzyme, kegg_errors, kegg_parser
from thermodynamic_errors import MissingCompoundFormationEnergy
...
class Kegg(Singleton):
    ...
    def FromAPI(self):
        ...
        cofactor_csv = csv.DictReader(open('../data/cofactors.csv', 'r'))
